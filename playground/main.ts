...
const BURST_GROUPS: {title: string; variants?: string[]; controls: Control[]}[] = [
  ...
  },
  {
    ...
    controls: [
      ...
      {kind: 'range', path: 'burst.rays', label: 'Rays', min: 0, max: 40, step: 1},
      {kind: 'range', path: 'burst.raysAlpha', label: 'Rays alpha', min: 0, max: 1, step: 0.05},
      {kind: 'range', path: 'burst.raysReach', label: 'Rays reach', min: 0.5, max: 5, step: 0.1},
      {kind: 'range', path: 'burst.raysSpin', label: 'Rays turn', min: -1, max: 1, step: 0.02},
  ...
  },
  {
    ...
    controls: [
      ...
      {kind: 'range', path: 'burst.snapReach', label: 'Landing front reach', min: 0.2, max: 3, step: 0.05},
      {kind: 'range', path: 'burst.snapAlpha', label: 'Landing front alpha', min: 0, max: 1, step: 0.05},
      {kind: 'range', path: 'burst.snapCoreAlpha', label: 'Landing hot edge', min: 0, max: 1, step: 0.05},
      {kind: 'range', path: 'burst.snapFlareReach', label: 'Landing flare reach', min: 0.2, max: 3, step: 0.05},
      {kind: 'range', path: 'burst.snapFlareAlpha', label: 'Landing flare alpha', min: 0, max: 1, step: 0.05},
      {kind: 'range', path: 'burst.snapKickMs', label: 'Landing shake, ms', min: 0, max: 800, step: 20},
      {kind: 'range', path: 'burst.snapKickAmp', label: 'Landing shake throw', min: 0, max: 0.08, step: 0.002},
      {kind: 'range', path: 'burst.snapFlashMs', label: 'Landing white-out, ms', min: 0, max: 500, step: 10},
      {kind: 'range', path: 'burst.snapFlashAlpha', label: 'Landing white-out alpha', min: 0, max: 1, step: 0.05},
    ],
  },
];
